      ...
      <div className={` documentation ${documentationShow ? "documentation-show" : "documentation-hide"}`}>
        ...
        <div className='documentation-container'>
          <div className="accordion-container">
            ...
            <p><strong>Click or touch</strong> videos, maps and pdfs from the top bar to <strong>drag</strong> them around. The item itself can be interacted with.</p>

            <p>The embedded videos, images, maps and pdfs can be <strong>resized</strong>, <strong>rotated</strong> and <strong> reordered</strong>. </p>
            ...
            <p>In the <strong>gallery</strong> at the bottom you can add color boxes with color code, uplodad images and add web links that will all stay there and can be added later to the board.</p>
            ...
            <p>When you <strong>upload</strong> a saved board in Json format it will be added as a new board. to the existing content so be careful to backup the existing content in its own Json file as some lines will be difficult to separate if the overlap.</p>
            ...
            <Accordion title="The Calculator">
              ...
              <p>Select and drag the result to the board</p>
            </Accordion>
            ...
            <Accordion title="Controls Panel">
              <p><strong>Theme</strong> switcher all buttons will get the selected color (resets with page refresh)</p>
              <p><strong>Print</strong> the board as pdf keeping the vector lines and text. (some items don't get printed or look different)</p>
              <p><strong>Erase</strong> all board</p>
              <p><strong>Erase</strong> all lines</p>
              <p><strong>Download</strong> the board as a viblle.json file that you can upload to another browser page. Backup, transfer or share.</p>
              <p><strong>Upload</strong> a saved board to add its content (may overlap with current content)</p>
              <p><strong>Zoom</strong> in, zoom out and reset zoom (resets when editing because zoomed out page complicates editing) (zoom out may come in handy to print the whole board in one page)</p>
              <p>Zoom slider</p>
            </Accordion>
